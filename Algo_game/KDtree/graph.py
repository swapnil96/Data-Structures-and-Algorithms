'''To make KDtree by clicking points'''
...
class KDTreeApp:
	...
	def __init__(self):
		...
		self.w = Tkinter.Frame(self.master, width = 810, height = 510)
		self.canvas = Tkinter.Canvas(self.w, width = 800, height = 500)
		self.paint()
