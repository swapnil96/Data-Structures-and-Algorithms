...
''' Note Prim's algorithm needs to know whether PQ contains vertex. This operation is not supported 
    (since it won't be efficient). Fortunately with O(n) extra storage, this function creates inqueue[] 
    dictionary to keep track of the vertices in the PQ'''
